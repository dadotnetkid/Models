...
namespace Helpers
{
    public static class GridViewHelpers
    {
        ...
        public static void AddAddEditDeleteToolbar(this GridViewSettings settings, Action<MVCxGridViewToolbar> items)
        {
            ...
            settings.Toolbars.Add(items);
        }

        public static void InitToolbarSettings(this GridViewSettings settings)
        {
            settings.SettingsBehavior.AllowFocusedRow = true;
            settings.CommandColumn.ShowEditButton = false;
            settings.CommandColumn.ShowNewButtonInHeader = false;
